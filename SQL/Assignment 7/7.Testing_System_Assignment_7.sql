...
DROP TRIGGER IF EXISTS before_groups_insert;
DELIMITER $$
CREATE TRIGGER before_groups_insert
...
VALUES				 ('group test', 11, '2020-03-20');
...
-- Question 7: Cấu hình 1 bài thi chỉ cho phép user tạo tối đa 4 answers 
-- cho mỗi question, trong đó có tối đa 2 đáp án đúng.
